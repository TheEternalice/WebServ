...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/26 17:13:41 by gebz              #+#    #+#             */
/*   Updated: 2025/08/26 17:13:41 by gebz             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef void (*ExtractFunction)(std::vector<std::string>& tokens, ServerBlock& server, std::ifstream& file);
